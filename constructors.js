...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  /*
    Write a constructor function, including method definitions, which will make the above function invocations 
    function properly.
...
function Car(make, model, year){
  ...
  /*
    Here we have a constructor function named Movie that takes in 3 parameters:
      name (a string), genre (a string), and rating (a number withing 1-100 that has been averaged out from previous 
        given ratings).
  ...
  */
  ...
  // array of objects. These objects will each have 3 properties: id (a number), title (a string), and rating 
  // (a number between 1 and 5). These objects are the posts that the user will have saved to their account.
  ...
  // these parameters to create a new object and add it to the savedPosts array. Make sure to name the properties 
  // the same as described previously (id, title, rating).
  ...
  // Write a prototype method for the User constructor function named changePostRating that will take in two number 
  // parameters. The first will be an id (a number) and the second will be the new rating (a number). Use the id to 
  // find the matching object in the savedPosts array. Once you find the matching object, update it's rating score 
  // with the new rating parameter.
